...
class ImageToPDFConcerter:
    ...
    def initialize_ui(self):
        title_label =tk.Label(self.root, text="Image to PDF Converter", font=("Helvertica", 16, "bold") )
        title_label.pack(pady=10)

        select_image_button =tk.Button(self.root, text="Select Images", command=self.selected_images,)
    ...
    def convert_images_to_pdf(self): 
        ...
        pdf = canvas.canvas(output_pdf_path, pagesize=(216, 792))
...
def main():
    ...
    converter = ImageToPDFConcerter(root)
